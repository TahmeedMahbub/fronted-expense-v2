...
(function () {
  ...
  // Donut Chart
  // --------------------------------------------------------------------
  const personalExpenseChartEl = document.querySelector('#personalExpenseChart'),
    personalExpenseChartConfig = {
      chart: {
        height: 390,
        fontFamily: 'Inter',
        type: 'donut'
  ...
  if (typeof personalExpenseChartEl !== undefined && personalExpenseChartEl !== null) {
    const personalExpenseChart = new ApexCharts(personalExpenseChartEl, personalExpenseChartConfig);
    personalExpenseChart.render();
  }
})();
